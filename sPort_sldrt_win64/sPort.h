...
#ifndef RTW_HEADER_sPort_h_
#define RTW_HEADER_sPort_h_
#include <string.h>
#include <math.h>
#ifndef sPort_COMMON_INCLUDES_
# define sPort_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "nesl_rtw.h"
#include "sPort_de6c5c35_gateway.h"
#include "sldrtdef.h"
#endif                                 /* sPort_COMMON_INCLUDES_ */
...
#define sPort_rtModel                  RT_MODEL_sPort_T

/* Block signals (auto storage) */
typedef struct {
  real_T STATE_1[4];                   /* '<S5>/STATE_1' */
} B_sPort_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  void* STATE_1_Simulator;             /* '<S5>/STATE_1' */
  void* STATE_1_SimulationData;        /* '<S5>/STATE_1' */
  void* STATE_1_DiagnosticManager;     /* '<S5>/STATE_1' */
  void* STATE_1_Logger;                /* '<S5>/STATE_1' */
  void* STATE_1_SampleTimeIdx;         /* '<S5>/STATE_1' */
  void* SINK_1_Simulator;              /* '<S5>/SINK_1' */
  void* SINK_1_SimulationData;         /* '<S5>/SINK_1' */
  void* SINK_1_DiagnosticManager;      /* '<S5>/SINK_1' */
  void* SINK_1_Logger;                 /* '<S5>/SINK_1' */
  void* SINK_1_SampleTimeIdx;          /* '<S5>/SINK_1' */
  boolean_T STATE_1_CallSimulatorOutput;/* '<S5>/STATE_1' */
  boolean_T SINK_1_CallSimulatorOutput;/* '<S5>/SINK_1' */
} DW_sPort_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Upper_RevoluteRzq[4];         /* '<S5>/STATE_1' */
} X_sPort_T;
...
/* State disabled  */
typedef struct {
  boolean_T Upper_RevoluteRzq[4];      /* '<S5>/STATE_1' */
} XDis_sPort_T;
...
#define rtB                            sPort_B
#define BlockIO                        B_sPort_T
#define rtX                            sPort_X
#define ContinuousStates               X_sPort_T
#define rtXdot                         sPort_XDot
#define StateDerivatives               XDot_sPort_T
#define tXdis                          sPort_XDis
#define StateDisabled                  XDis_sPort_T
#define rtDWork                        sPort_DW
#define D_Work                         DW_sPort_T

/* Real-time Model Data Structure */
struct tag_RTM_sPort_T {
  const char_T *path;
...
/* Block signals (auto storage) */
extern B_sPort_T sPort_B;

/* Continuous states (auto storage) */
extern X_sPort_T sPort_X;

/* Block states (auto storage) */
extern DW_sPort_T sPort_DW;

/* Model entry point functions */
extern void sPort_initialize(void);
extern void sPort_output(void);
extern void sPort_update(void);
extern void sPort_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern sPort_rtModel *sPort(void);
...
extern RT_MODEL_sPort_T *const sPort_M;
 ...
 * '<S1>'   : 'sPort/Base'
 * '<S2>'   : 'sPort/Lower Link'
 * '<S3>'   : 'sPort/Solver Configuration'
 * '<S4>'   : 'sPort/Upper Link'
 * '<S5>'   : 'sPort/Solver Configuration/EVAL_KEY'
 */
#endif                                 /* RTW_HEADER_sPort_h_ */
